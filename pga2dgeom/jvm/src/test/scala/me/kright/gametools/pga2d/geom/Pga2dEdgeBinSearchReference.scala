...
/**
 * former Pga2dEdge.getNearestPointsBinSearch, removed from the library (slow, allocating,
 ...
 */
object Pga2dEdgeBinSearchReference:
  def getNearestPoints(a: Pga2dEdge, b: Pga2dEdge,
