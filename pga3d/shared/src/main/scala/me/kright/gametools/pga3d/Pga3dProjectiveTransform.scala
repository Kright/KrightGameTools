 ...
 * rounding for any motor, normalized or not. See [[Pga3dTransform]] for the
 ...
 */
final case class Pga3dProjectiveTransform(motor: Pga3dMotor,
  ...
  override def toString: String =
    s"Pga3dProjectiveTransform($motor)"
...
object Pga3dProjectiveTransform:
  val id: Pga3dProjectiveTransform = Pga3dProjectiveTransform(Pga3dMotor.id)

  def apply(motor: Pga3dMotor): Pga3dProjectiveTransform =
    val s = motor.s
    val wx = motor.wx
    val wy = motor.wy
    val wz = motor.wz
