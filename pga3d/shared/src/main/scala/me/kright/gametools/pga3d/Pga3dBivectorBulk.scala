...
final case class Pga3dBivectorBulk(xy: Double = 0.0,
  ...
  infix def wedge(v: Pga3dRotor): Pga3dBivectorBulk =
    Pga3dBivectorBulk(
      xy = v.s * xy,
      xz = v.s * xz,
      yz = v.s * yz,
  ...
  inline infix def ^(v: Pga3dRotor): Pga3dBivectorBulk = wedge(v)

  inline infix def meet(v: Pga3dRotor): Pga3dBivectorBulk = wedge(v)
